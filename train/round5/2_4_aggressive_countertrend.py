...
HIGH_VOL_PRODUCTS = {
    ...
    "PICNIC_BASKET1", "PICNIC_BASKET2", "MAGNIFICENT_MACARONS", "SQUID_INK"
}

# 参数 - 更激进的设置
PARAM = {
    "trend_window": 25,       # 缩短趋势检测窗口
    "trend_threshold": 0.65,  # 降低趋势检测阈值，使趋势信号更容易触发
    "reversal_window": 4,     # 缩短反转检测窗口
    "reversal_threshold": 0.75, # 降低反转检测阈值，使反转信号更容易触发
    "position_limit_pct": 0.75, # 提高仓位限制百分比
    "mm_size_frac": 0.2,      # 增加做市规模
    "counter_size_frac": 0.35, # 增加反趋势交易规模
    "min_spread": 1,          # 降低最小价差
    "vol_scale": 1.4,         # 增加波动率缩放因子
    "rsi_period": 12,         # 缩短RSI周期，更快反应
    "rsi_overbought": 65,     # 降低RSI超买阈值，更早进行反向卖出
    "rsi_oversold": 35        # 提高RSI超卖阈值，更早进行反向买入
}
