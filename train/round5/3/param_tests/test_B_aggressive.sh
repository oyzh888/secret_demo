...
cp /Users/zhihaoouyang/Desktop/code/imc_prosperity/secret_demo/train/round5/3/param_tests/params_B_aggressive.json /Users/zhihaoouyang/Desktop/code/imc_prosperity/uploaded_params.json

# Run the test
echo "Testing Parameter Set B (Aggressive)..."
