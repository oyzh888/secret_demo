...
# —— 运行时参数 - C-conservative: streak thr = 3，mean‑revert 关闭
PARAM_DEFAULT = {
    # ▸ Passive MM
    ...
    "counterparties": {          # 每个对手的默认阈值 & 下单比例
        "Camilla": {"thr": 3, "size_frac": 0.08},  # 更保守：thr 从 2 增加到 3，size_frac 从 0.10 减少到 0.08
        "Caesar":  {"thr": 3, "size_frac": 0.08}   # 更保守：thr 从 2 增加到 3，size_frac 从 0.10 减少到 0.08
    },
    "mean_revert_after": False   # 更保守：关闭平均回转
}
